...
class $AssetsIconsGen {
  ...
  List<AssetGenImage> get values =>
      [bluePen, hashtagicon, home, microphon, user, write];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/teckbot.svg
  SvgGenImage get teckbot => const SvgGenImage('assets/images/teckbot.svg');

  /// List of all assets
  List<dynamic> get values => [arrow, avatar, logoo, posterTest, teckbot];
}
